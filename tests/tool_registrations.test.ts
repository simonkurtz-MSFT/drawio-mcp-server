...
describe("TOOL_NAMES", () => {
  it("should contain 23 tool name entries", () => {
...
describe("TOOL_DEFINITIONS", () => {
  it("should contain 23 tool definitions", () => {
    assertEquals(TOOL_DEFINITIONS.length, 23);
  });
...
describe("registerTools", () => {
  ...
  it("should register exactly 23 tools", () => {
    ...
    assertEquals(registerSpy.calls.length, 23);
    registerSpy.restore();
  });
